class MoviesController < ApplicationController
  ...
  def search_results
    ...
    @movies = @movies.where('year >= ?', params[:decade_from]) if params[:decade_from] && params[:decade_from] != "Select Decade"
    @movies = @movies.where('year <= ?', params[:decade_to]) if params[:decade_to] && params[:decade_to] != "Select Decade"
